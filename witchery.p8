...
function spawn_entities(x,y)
	...
	if x==0 and y==0 then
		...
		create_red_bat(16,16)
		create_brown_bat(1,16)
...
function move_worm(x,y)
	
end

function create_worm(spawnx,spawny)
	add(worm,{x=spawnx*8,y=spawny*8,
				h=16,w=16,airange=128,
				lives=10,direction==0})
end

function despawn_worm()
	for w in all(worm) do
		del(worm, w)
	end
end
...
function move_wizard(x,y)
	
end

function create_wizard(spawnx,spawny)
	add(wizard,{x=spawnx*8,y=spawny*8,
				h=16,w=16,airange=128,
				lives=10,direction==0})
end

function despawn_wizard()
	for w in all(wizard) do
		del(wizard, w)
	end
end
...

...
__gff__

...

...
011000200214002020021100204002120020100214002020051100504005120050100514005020051100504004120040100414004020041100404004120040100714007020071100704007120070100714007010
